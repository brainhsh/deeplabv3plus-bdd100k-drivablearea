...
def main():
    ...
    parser.add_argument('--inference', action='store_true', default=False,
			help='inference mode on (w/o train)')
    parser.add_argument('--eval', action='store_true', default=False,
			help='evaluation mode w/o inference')
    parser.add_argument('--submit', action='store_true', default=False,
			help='submission inference mode')
    ...
    if args.inference:
        trainer.validation(args.start_epoch, inference=args.inference)
        return
    elif args.eval:
